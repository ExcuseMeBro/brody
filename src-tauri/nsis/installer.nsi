; Custom NSIS template for Brody with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Brody for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Brody releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Brody Portable Mode"
    FileClose $0
