...
export const ModelsSettings: React.FC = () => {
  ...
  const handleImportCustomModel = async () => {
    const selected = await open({
      ...
      filters: [
        {
          name: t("settings.models.customImportFilterName"),
          extensions: ["bin"],
        },
      ],
    });
    ...
    const importedModel = await importCustomModel(selected);
    if (importedModel) {
      toast.success(
        t("settings.models.customImportSuccess", {
          modelName: importedModel.name,
        }),
      );
    } else {
      toast.error(t("settings.models.customImportError"));
    }
  };
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg bg-logo-primary/15 text-logo-primary hover:bg-logo-primary/25 transition-colors"
                >
                  <Upload className="w-3.5 h-3.5" />
                  <span className="max-w-[140px] truncate">
                    {t("settings.models.importCustomModel")}
                  </span>
                </button>
