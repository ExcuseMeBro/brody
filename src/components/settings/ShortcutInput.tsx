...
import { BrodyKeysShortcutInput } from "./BrodyKeysShortcutInput";
 ...
 * - "brody_keys": Uses BrodyKeysShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "brody_keys") {
    return <BrodyKeysShortcutInput {...props} />;
  }
